...
This file is the fp32 version of the ZeRO optimizer, which in turn was
adapted from FP16_Optimizer in NVIDIA/apex
'''
...
from deepspeed.pt.deepspeed_zero_optimizer import flatten_dense_tensors_aligned, _initialize_parameter_parallel_groups


class FP32_DeepSpeedZeroOptimizer(object):
    """
